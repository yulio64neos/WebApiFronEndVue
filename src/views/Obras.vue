<template>
  <div class="container">
    ...
    <form @submit="PostApi">
      ...
      <div class="mb-3">
        <label for="CorreoResponsable" class="form-label"
          >Correo responsable</label
        >
        <input
          type="email"
          v-model="post.Correo_resp"
          class="form-control"
          id="Correo_resp"
        />
      </div>
...
export default {
  data: () => ({
    ...
    json_fields: {
      ...
      "Telefono Responsable": "Tel_resp",
      "Correo Responsable": "Correo_resp"
    },
    json_data: [],
    json_meta: [
      [
  ...
  methods: {
    GetApi() {
      this.axios
        .get("http://20.247.89.187/yulio64neos/api/Obra/Get")
        .then((res) => {
            this.data = res.data,
    ...
    PostApi(e) {
      ...
      if (bandera) {
        this.axios
          .post("http://20.247.89.187/yulio64neos/api/Obra/Post", this.post)
